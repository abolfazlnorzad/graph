...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/middleware.Envelope"
                                },
                                {
                                    "type": "object",
                                    "properties": {
                                        "data": {
                                            ...
                                            "properties": {
                                                ...
                                                "tasks": {
                                                    "type": "array",
                                                    "items": {
                                                        "$ref": "#/definitions/param.TaskResponse"
                                                    }
                                                }
                                            }
                                        }
    ...
    "definitions": {
        ...
        "param.AuditLogResponse": {
            "type": "object",
            "properties": {
                "action": {
                    "$ref": "#/definitions/entity.TaskAction"
                },
                "created_at": {
                    "type": "string"
                },
        ...
        "param.TaskResponse": {
            ...
            "properties": {
                ...
                "audit_logs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/param.AuditLogResponse"
                    }
                },
                "created_at": {
                    "type": "string"
